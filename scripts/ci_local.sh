...
for s in scripts/qihara.py scripts/qihara_general.py scripts/weil_positivity.py scripts/bc_entropy.py scripts/bc_symmetry_generators.py scripts/cmps_parity_supertrace.py scripts/ring_norm_certificate.py scripts/graded_permutation.py scripts/phase_side_lindbladian.py; do
  n="$(basename "$s" .py)"
