...
WT.demos.perm = function(root){
  ...
  WT.select(ctr, 'perm_mode', 'closure', [['poles','untwisted: t_k = Tr P^k'],['twisted','twisted by parity: t_k = Tr(Π P^k)']], st.mode, v => { st.mode = v; draw(); });
