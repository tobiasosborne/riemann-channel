...
"$bin" --curve 11a1 --x 13 --Nmax 60 --prec 1000 --cprec 700 --cmp 20,40,60 > outputs/rtp2_ellcurve_pilot_11a1.txt 2> "$ck/pilot.log"
...
result=0
for task_pid in "${task_pids[@]}"; do wait "$task_pid" || result=1; done
