...
\begin{itemize}
  ...
  file under \texttt{notes/reviews/}. Author and reviewer identities are
  recorded per claim. The notebook includes Claude and OpenAI models;
  individual reviews state whether the roles use different families.
...
\input{report/generated/status.tex}
