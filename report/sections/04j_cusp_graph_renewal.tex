...
of unity, $d = \gcd\{m: m_{\reb}(m)>0\}$, each simple. Aperiodicity holds iff $0$ is not a resonance, i.e.
$c\ne1$, whenever the range of $\reb$ contains an eigenvector of $C$; it can fail with nonreal resonances:
