...
set -eu
cd "$(dirname "$0")"
IDS="2204.06424 2208.14032 2607.27935 1103.0605 1801.00876 2012.08759 2304.05714 2602.15180 0709.1142 0706.0556 2309.15873 2105.02677 1103.0079 2209.07024 2104.10287 2405.04361 1306.4203 1403.0256 math/0407288 math/0402356 1511.04265 1606.04560 1607.08053 1108.5659 1710.00603"
...
for id in $IDS; do
  ...
  find "$d" -type f \( -name '*.tex' -o -name '*.bbl' \) | LC_ALL=C sort | while read -r f; do sha256sum "$f"; done >> manifest.sha256
